...
# Read data
    spotify_df = pd.read_csv(r'C:\GUVI\Code\Project\.venv\Final Project\Spotify_pred_Dataset.csv')
    ...
    # streamlit run "C:\GUVI\Code\Project\.venv\Final Project\spotify.py" 